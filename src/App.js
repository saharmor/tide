...
const App = () => {
  ...
  return (
    <Container className="text-center justify-content-center align-items-center" fluid="md">
      ...
      <Row>
        <span className="small text-secondary">Images generated by <a href="https://openai.com/dall-e-2/?utm_source=thisimagedoesnotexist.com" target="_blank" rel="noopener noreferrer">DALL-E 2</a> and VQGAN generative models. Human images are free-to-use.</span>
      </Row>
    </Container>
  );
}
