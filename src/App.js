  ...
  return (
    <Container className="text-center justify-content-center align-items-center" fluid="md">
      ...
      {isFinished() && <Row className="justify-content-center text-center">
        ...
        <TwitterShareButton url="https://thisimagedoesnotexist.com" title={`Can you tell if an image was generated by a human or a machine? I scored ${score}!`}>
          <TwitterIcon size={24} round />
        </TwitterShareButton>
        &nbsp;
        <FacebookShareButton url="https://thisimagedoesnotexist.com" quote={`Can you tell if an image was generated by a human or a machine? I scored ${score}!`}>
          <FacebookIcon size={24} round />
        </FacebookShareButton>
        &nbsp;
        <RedditShareButton url="https://thisimagedoesnotexist.com" title={`Can you tell if an image was generated by a human or a machine? I scored ${score}!`}>
